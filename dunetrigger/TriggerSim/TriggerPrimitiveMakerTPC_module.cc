...
//
// Generated at Tue Nov 14 05:00:20 2023 by Wesley Ketchum using cetskelgen from  version .
////////////////////////////////////////////////////////////////////////
...
void dunetrigger::TriggerPrimitiveMakerTPC::produce(art::Event &e) {
  ...
  if (verbosity_ >= Verbosity::kInfo) std::cout << "Found " << rawdigit_vec.size() << " raw::RawDigits" << std::endl;


  // try to get the associated timestamps to our rawdigit objects & check if they're valid
  ...
  for (size_t i_digit = 0; i_digit < rawdigit_vec.size(); ++i_digit) {
    ...
    tpalg_->process_waveform(digit.ADCs(), digit.Channel(), (uint16_t)(dunedaq::detdataformats::DetID::Subdetector::kHD_TPC),this_timestamp, *tp_col_ptr);
  }
