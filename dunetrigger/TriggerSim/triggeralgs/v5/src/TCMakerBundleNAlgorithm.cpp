...
#include "dunetrigger/TriggerSim/triggeralgs/v5/include/triggeralgs/BundleN/TCMakerBundleNAlgorithm.hpp"
...
void TCMakerBundleNAlgorithm::set_tc_attributes() {
    ...
    dunedaq::trgdataformats2::TriggerActivityData front_ta = m_current_tc.inputs.front();
