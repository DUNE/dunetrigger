...
#include "dunetrigger/TriggerSim/triggeralgs/v5/include/triggeralgs/Supernova/TCMakerSupernovaAlgorithm.hpp"
...
TCMakerSupernovaAlgorithm::process(const TriggerActivity& activity, std::vector<TriggerCandidate>& cand)
{
  ...
  if (m_activity.size() > m_threshold) {
    ...
    detid_t detid = dunedaq::trgdataformats2::WHOLE_DETECTOR;
