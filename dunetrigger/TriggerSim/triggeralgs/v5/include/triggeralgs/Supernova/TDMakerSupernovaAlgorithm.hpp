...
#include "dunetrigger/TriggerSim/triggeralgs/v5/include/triggeralgs/TriggerDecisionMaker.hpp"
...
protected:
  ...
  std::atomic<dunedaq::trgdataformats2::timestamp_t> m_time_window = { 500'000'000 };
  ...
  void FlushOldCandidate(dunedaq::trgdataformats2::timestamp_t time_now)
  {
    dunedaq::trgdataformats2::timestamp_diff_t how_far = time_now - m_time_window;
    auto end = std::remove_if(
                              m_candidate.begin(), m_candidate.end(), [how_far, this](auto& c) -> bool { return (static_cast<dunedaq::trgdataformats2::timestamp_diff_t>(c.time_start) < how_far); });
