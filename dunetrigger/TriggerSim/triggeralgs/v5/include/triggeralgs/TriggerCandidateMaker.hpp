...
#include "dunetrigger/TriggerSim/triggeralgs/v5/include/triggeralgs/Issues.hpp"
#include "dunetrigger/TriggerSim/triggeralgs/v5/include/triggeralgs/Logging.hpp"
...
#include "dunetrigger/TriggerSim/triggeralgs/v5/include/triggeralgs/Types.hpp"
  ...
  virtual void configure(const nlohmann::json& config)
  {
    ...
    if (config.contains("tc_type_name")) {
      m_tc_type_out = static_cast<TriggerCandidate::Type>(
          dunedaq::trgdataformats2::string_to_trigger_candidate_type(config["tc_type_name"]));
    }
