...
// (eg from TriggerCandidate to dunedaq::trgdataformats2::TriggerCandidate). The point of
...
// like `using overlay_t = dunedaq::trgdataformats2::Trigger(Activity|Candidate);`, but I
...
{
  using overlay_t = dunedaq::trgdataformats2::TriggerActivity;
  using data_t = dunedaq::trgdataformats2::TriggerActivityData;
};

template<>
struct TypeToOverlayType<TriggerCandidate>
{
  using overlay_t = dunedaq::trgdataformats2::TriggerCandidate;
  using data_t = dunedaq::trgdataformats2::TriggerCandidateData;
};
...
// Given an overlay object (dunedaq::trgdataformats2::TriggerActivity or
// dunedaq::trgdataformats2::TriggerCandidate), create a corresponding non-overlay object
...
// Given a buffer containing an overlay object (dunedaq::trgdataformats2::TriggerActivity
// or dunedaq::trgdataformats2::TriggerCandidate), create a corresponding non-overlay
